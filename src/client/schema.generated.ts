...
/** Input for the createProductos mutation */
export interface CreateProductosInput {
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars["ID"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
...
/** Input for the deleteProductos mutation */
export interface DeleteProductosInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars["Boolean"]>;
  /** The ID of the productos to delete */
  id: Scalars["ID"];
}
...
/** Arguments for filtering the RootQueryToProductosConnection connection */
export interface RootQueryToProductosConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Input for the updateProductos mutation */
export interface UpdateProductosInput {
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars["ID"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars["String"]>;
  /** The ID of the productos object */
  id: Scalars["ID"];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: InputMaybe<Scalars["Int"]>;
  /** The password used to protect the content of the object */
...
/** Arguments for filtering the UserToProductosConnection connection */
export interface UserToProductosConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export const generatedSchema = {
  ...
  CreateProductosPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    productos: { __type: "Productos" },
  },
  ...
  DeleteProductosInput: {
    clientMutationId: { __type: "String" },
    forceDelete: { __type: "Boolean" },
    id: { __type: "ID!" },
  },
  DeleteProductosPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    deletedId: { __type: "ID" },
    productos: { __type: "Productos" },
  ...
  Productos: {
    ...
    modified: { __type: "String" },
    modifiedGmt: { __type: "String" },
    preview: { __type: "ProductosToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    productosId: { __type: "Int!" },
    slug: { __type: "String" },
    status: { __type: "String" },
    template: { __type: "ContentTemplate" },
    templates: { __type: "[String]" },
  ...
  RootQueryToProductosConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToProductosConnectionEdge]" },
    nodes: { __type: "[Productos]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToProductosConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Productos" },
  },
  RootQueryToProductosConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  User: {
    ...
    producto: {
      __type: "UserToProductosConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToProductosConnectionWhereArgs",
      },
    },
  ...
  UserToProductosConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToProductosConnectionEdge]" },
    nodes: { __type: "[Productos]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToProductosConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Productos" },
  },
  UserToProductosConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  mutation: {
    ...
    createProductos: {
      __type: "CreateProductosPayload",
      __args: { input: "CreateProductosInput!" },
    },
    ...
    deleteProductos: {
      __type: "DeleteProductosPayload",
      __args: { input: "DeleteProductosInput!" },
    },
    ...
    updateProductos: {
      __type: "UpdateProductosPayload",
      __args: { input: "UpdateProductosInput!" },
    },
  ...
  query: {
    ...
    producto: {
      __type: "RootQueryToProductosConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToProductosConnectionWhereArgs",
      },
    },
    productos: {
      __type: "Productos",
      __args: { asPreview: "Boolean", id: "ID!", idType: "ProductosIdType" },
    },
    productosBy: {
      __type: "Productos",
      __args: { id: "ID", productosId: "Int", slug: "String", uri: "String" },
    },
    productsService: {
...
/**
 * The payload for the createProductos mutation
 */
export interface CreateProductosPayload {
  __typename?: "CreateProductosPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the deleteProductos mutation
 */
export interface DeleteProductosPayload {
  __typename?: "DeleteProductosPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface Productos {
  ...
  guid?: Maybe<ScalarsEnums["String"]>;
  /**
   * The globally unique identifier of the productos object.
   */
  id: ScalarsEnums["ID"];
  /**
   * Whether the node is a Content Node
  ...
  modifiedGmt?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the productos type and the productos type
   */
  preview?: Maybe<ProductosToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums["Int"]>;
 ...
 * Connection between the productos type and the productos type
 */
export interface ProductosToPreviewConnectionEdge {
  __typename?: "ProductosToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
...
/**
 * Connection between the RootQuery type and the productos type
 */
export interface RootQueryToProductosConnection {
  __typename?: "RootQueryToProductosConnection";
  /**
   * Edges for the RootQueryToProductosConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToProductosConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Productos>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToProductosConnectionEdge {
  __typename?: "RootQueryToProductosConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the updateProductos mutation
 */
export interface UpdateProductosPayload {
  __typename?: "UpdateProductosPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface User {
  ...
  /**
   * Connection between the User type and the productos type
   */
  producto: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToProductosConnectionWhereArgs>;
  }) => Maybe<UserToProductosConnection>;
  /**
 ...
 * Connection between the User type and the productos type
 */
export interface UserToProductosConnection {
  __typename?: "UserToProductosConnection";
  /**
   * Edges for the UserToProductosConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToProductosConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Productos>>>;
 ...
 * An edge in a connection
 */
export interface UserToProductosConnectionEdge {
  __typename?: "UserToProductosConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Mutation {
  ...
  createProductos: (args: {
    input: CreateProductosInput;
  }) => Maybe<CreateProductosPayload>;
  ...
  deleteProductos: (args: {
    input: DeleteProductosInput;
  }) => Maybe<DeleteProductosPayload>;
...
export interface Query {
  ...
  producto: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToProductosConnectionWhereArgs>;
  }) => Maybe<RootQueryToProductosConnection>;
  productos: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<ProductosIdType>;
  }) => Maybe<Productos>;
  productosBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
    productosId?: Maybe<Scalars["Int"]>;
    slug?: Maybe<Scalars["String"]>;
    uri?: Maybe<Scalars["String"]>;
  }) => Maybe<Productos>;
...
export interface SchemaObjectTypes {
  ...
  CreateProductosPayload: CreateProductosPayload;
  ...
  DeleteProductosPayload: DeleteProductosPayload;
  ...
  RootQueryToProductosConnection: RootQueryToProductosConnection;
  RootQueryToProductosConnectionEdge: RootQueryToProductosConnectionEdge;
  ...
  UpdateProductosPayload: UpdateProductosPayload;
  ...
  UserToProductosConnection: UserToProductosConnection;
  UserToProductosConnectionEdge: UserToProductosConnectionEdge;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  ProductosIdType: ProductosIdType | undefined;
